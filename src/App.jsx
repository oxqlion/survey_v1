  ...
  return (
    <div className='p-2 flex flex-col items-center justify-start w-full h-screen'>
      ...
      <div className="flex w-full items-center justify-between p-8">
        ...
        {answered.length == 5 ? (
          <button className='py-2 px-6 bg-black text-white rounded-md hover:bg-gray-100 hover:text-black transition ease-in-out' onClick={() => setSubmitted(true)}>Submit</button>
        ) : (
